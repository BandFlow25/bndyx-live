...
// New BNDY-AUTH system types.
export type UserRole = 'live_admin' | 'live_builder' | 'live_giggoer' | 'GODMODE';

export interface DecodedToken {
  sub: string;          // User ID standard JWT claim
  uid?: string;         // Alternative User ID field
  email: string;        // User email
  name?: string;        // User name standard
  displayName?: string; // Alternative display name field
